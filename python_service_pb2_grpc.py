...
class DocumentServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.findFrequencyDistribution = channel.unary_unary(
        ...
        request_serializer=python__service__pb2.FrequencyDistributionRequest.SerializeToString,
        response_deserializer=python__service__pb2.FrequencyDistribution.FromString,
        )
...
def add_DocumentServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'findFrequencyDistribution': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=python__service__pb2.FrequencyDistributionRequest.FromString,
          response_serializer=python__service__pb2.FrequencyDistribution.SerializeToString,
      ),
  }
...
class LdaStub(object):
  ...
  def __init__(self, channel):
    ...
    self.treinarModeloLDAComDocumentos = channel.stream_unary(
        ...
        request_serializer=python__service__pb2.DocumentoConteudo.SerializeToString,
...
def add_LdaServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'treinarModeloLDAComDocumentos': grpc.stream_unary_rpc_method_handler(
          ...
          request_deserializer=python__service__pb2.DocumentoConteudo.FromString,
...
class RecomendacaoStub(object):
  ...
  def __init__(self, channel):
    ...
    self.buscarRecomendacoes = channel.unary_unary(
        ...
        request_serializer=python__service__pb2.RecomendacaoRequest.SerializeToString,
        response_deserializer=python__service__pb2.RecomendacaoResponse.FromString,
        )
...
def add_RecomendacaoServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'buscarRecomendacoes': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=python__service__pb2.RecomendacaoRequest.FromString,
          response_serializer=python__service__pb2.RecomendacaoResponse.SerializeToString,
      ),
